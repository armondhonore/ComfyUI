...
**Live:** [https://relaxed-weasel-comfyui.cloud.nexlayer.ai](https://relaxed-weasel-comfyui.cloud.nexlayer.ai)  
...
**comfyui** is deployed on [Nexlayer](https://nexlayer.ai) — a container-native
...
application:
  ...
  pods:
  - name: app
    image: mirror.gcr.io/yanwk/comfyui-boot:nightly
    path: /
    servicePorts:
    - 8188
    vars:
